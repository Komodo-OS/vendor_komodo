...
ALARM_PATH := vendor/komodo/prebuilt/common/media/audio/alarms
NOTIFICATION_PATH := vendor/komodo/prebuilt/common/media/audio/notifications
RINGTONE_PATH := vendor/komodo/prebuilt/common/media/audio/ringtones
